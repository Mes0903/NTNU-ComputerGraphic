...
function draw(){
    ...
    mdlMatrix = new Matrix4().scale(2.0, 0.1, 2.0);
    drawOneObject(cube, mdlMatrix, 1.0, 0.4, 0.4);

    //mario
    //TODO-2: set mdlMatrix for mario
    mdlMatrix = new Matrix4().setTranslate(-1, 0.75, 0).scale(0.01, 0.01, 0.01);
    drawOneObject(mario, mdlMatrix, 0.4, 1.0, 0.4);

    //sonic
    //TODO-3: set mdlMatrix for sonic (include rotation and movement)
    mdlMatrix = new Matrix4().setTranslate(1+moveDistance, 0.1, 0).rotate(rotateAngle, 0, 1, 0).scale(0.04, 0.04, 0.04);
